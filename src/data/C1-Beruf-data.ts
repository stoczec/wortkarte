...
export const C1_Beruf_data: ILanguageCard[] = [
    ...
    },
    {
        ...
        wordClass: EnumWORDCLASSES.FEMININ,
        exampleDe: 'Die steigende Nachfrage nach nachhaltigen Produkten zwang Unternehmen zum Umdenken.',
        exampleRu: 'Растущий спрос на экологичные товары заставил компании пересмотреть свои стратегии.',
      ...
      },
      {
        ...
        exampleRu: 'Текущая экономическая конъюнктура демонстрирует признаки легкого восстановления.',
      ...
      },
      {
        ...
        wordClass: EnumWORDCLASSES.FEMININ,
        exampleDe: 'Wirtschaftsgüter sind materielle und immaterielle Produkte, die zur Bedarfsdeckung dienen.',
        exampleRu: 'Экономические блага - это материальные и нематериальные продукты, служащие для удовлетворения потребностей.',
      ...
      },
      {
        ...
        exampleRu: 'Производственные издержки были снижены благодаря более эффективным производственным процессам.',
