...
export const C1_Beruf_data: ILanguageCard[] = [
    ...
    },
    {
        ...
        article: 'die',
        pluralEnding: ', -en',
        wordDe: 'Übertragung, überträgt, hat übertragen',
        wordRu: 'передавать, транслировать',
        wordClass: EnumWORDCLASSES.VERB,
        exampleDe: 'Der Moderator übertrug die Nachricht live ins Studio.',
        exampleRu: 'Ведущий передал новость в прямом эфире в студию.',
        fileKeyUploadthing: 'Yosg29JtFzNhy3C3it9rDLWcC2lIrhH17xJvjKnQR9ws536e',
    },
    {
